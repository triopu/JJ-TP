      ...
      var Tab1Page = /*#__PURE__*/function () {
        ...
        _createClass(Tab1Page, [{
          ...
          value: function getData() {
            ...
            fetch("assets/data/api-slider.json").then(function (res) {
              return res.json();
            }).then(function (json) {
              _this.data = json;
          ...
          value: function getProduct() {
            ...
            fetch("assets/data/api-featured-product.json").then(function (res) {
              ...
              _this2.products = json;
              console.log(_this2.products);
            });
          }
        }, {
          key: "getPurchased",
          value: function getPurchased() {
            var _this3 = this;

            fetch("assets/data/api-last-purchased.json").then(function (res) {
              return res.json();
            }).then(function (json) {
              _this3.purchased = json;

              for (var i = 0; i < _this3.purchased.data.length; i++) {
                _this3.price = parseInt(_this3.price) + parseInt(_this3.purchased.data[0].price);
              }

              console.log(_this3.purchased);
            });
          }
        }, {
          key: "getPesan",
          value: function getPesan() {
            this.getPurchased();
            this.pesan = true;
          }
        }, {
          key: "closePesan",
          value: function closePesan() {
          ...
          key: "navigation",
          value: function navigation(param) {
            console.log(param);
